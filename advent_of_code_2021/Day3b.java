...
public class Day3b {
  ...
  static void populateNextArrayOfStrings(List<ArrayList<String>> dataset, int array_position, int char_position,
      String get_me) {
    // TODO:
    // Make a switch for dataset.size == 2,
    // get "1" for oxygen generator rating,
    // and get "0" for CO2 scrubbing rating.
  ...
  static String loopOverCollection(List<ArrayList<String>> dataset, ArrayList<String> current_dataset,
    ...
    String get_me;
    if (min_or_max.equals("max")) {
      get_me = (counts.get("1") >= counts.get("0")) ? "1" : "0";
    } else {
      get_me = (counts.get("1") >= counts.get("0")) ? "0" : "1";
    }
    ...
    // return "Ha!";
    return loopOverCollection(dataset, dataset.get(array_position), array_position, char_position, min_or_max);

  };

  public static void main(String[] args) {
    String[] sampleinput = { "00100", "11110", "10110", "10111", "10101", "01111", "00111", "11100", "10000",
        "11001", "00010", "01010" };
    ...
    oxygen_generator_rating = loopOverCollection(arrayOfArrayOfStrings, current_dataset, array_position, char_position,
        "max");
    arrayOfArrayOfStrings.clear();
    arrayOfArrayOfStrings.add(current_dataset);
    co2_scrubber_rating = loopOverCollection(arrayOfArrayOfStrings, current_dataset, array_position, char_position,
        "min");

    System.out.println("raw oxygen_generator_rating: " + oxygen_generator_rating + ". decimal oxygen_generator_rating: "
        + Integer.parseInt(oxygen_generator_rating, 2));
    System.out.println("raw co2_scrubber_rating: " + co2_scrubber_rating + ". decimal co2_scrubber_rating: "
        + Integer.parseInt(co2_scrubber_rating, 2));
    System.out.println(
        "Final answer is: " + Integer.parseInt(oxygen_generator_rating, 2) * Integer.parseInt(co2_scrubber_rating, 2));
  };
}
